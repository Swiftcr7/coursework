...
#ifndef SERVER_ALLOCATOR_ON_SORTE_LIST_H
#define SERVER_ALLOCATOR_ON_SORTE_LIST_H
...
public:
    allocator_on_sorted_list(size_t size, detour det = detour::first, logger* log = nullptr, memory* alloc = nullptr){
        ...
        *reinterpret_cast<size_t*>(block) = size - sizeof(size_t) - sizeof(void*) - sizeof(memory*) - sizeof(logger*) - sizeof(detour);
...
#endif //SERVER_ALLOCATOR_ON_SORTE_LIST_H
