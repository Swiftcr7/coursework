...
public:
    ...
    public:
        ...
        void remove_after(tkey const& key, typename binary_search_tree<tkey, tvalue, tkey_comparer>::node** root, std::stack<typename binary_search_tree<tkey, tvalue, tkey_comparer>::node*>* way_to_remove, logger* logger, size_t& place, size_t& color_removing) override{
            auto** AVL_root = reinterpret_cast<node_AVL**>(root);
